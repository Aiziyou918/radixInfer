...
if TYPE_CHECKING:
    from radixinfer.layers import RMSNorm
    from radixinfer.models.config import RotaryConfig


class AttentionLayer(StateLessOP):
    """Stateless attention layer: splits QKV, applies RoPE, delegates to global attention backend."""
