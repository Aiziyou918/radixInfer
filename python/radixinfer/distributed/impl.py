...
if TYPE_CHECKING:
    from radixinfer.distributed.info import DistributedInfo
...
class PyNCCLDistributedImpl(DistributedImpl):
    comm: object  # PyNCCLCommunicator
    ...
    def all_gather(self, x: torch.Tensor) -> torch.Tensor:
        from radixinfer.distributed.info import get_tp_info
...
def enable_pynccl_distributed(
    ...
    if tp_info.size == 1:
        return
    from radixinfer.kernel import init_pynccl
